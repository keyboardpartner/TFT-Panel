...
#ifndef _SliderVertWidgetH_
#define _SliderVertWidgetH_
...
class SliderVertWidget : public GUIObject {

  public:
  //SwitchWidget(TFT_eSPI *tft, TouchProvider *touchProvider) {}
	SliderVertWidget(TFT_eSPI *tft, TouchProvider *touchProvider) : GUIObject(tft, touchProvider) { }
