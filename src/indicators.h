#ifndef _LEDINDICATORH_
#define _LEDINDICATORH_
...
class LedIndicator : public GUIObject {

public:
	// Constructor to initialize the LED widget with default values
	// Uses TFT_eSPI for drawing on the display
	LedIndicator(TFT_eSPI *tft, TouchProvider *touchProvider) : GUIObject(tft, touchProvider) { }
