...
class NumericDisplayWidget : public GUIObject
{
public:
  NumericDisplayWidget(TFT_eSPI *tft, TouchProvider *touchProvider) : GUIObject(tft, touchProvider) { }
