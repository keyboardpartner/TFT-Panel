...
Other hardware quirks are [mentioned here](https://github.com/hexeguitar/ESP32_TFT_PIO), like modifying the the completely useless LDR (light dependant resistor) circuit or reducing the much too high audio gain. This is a fine example how chinese manufacturers copy & paste even obvious faults and errors. Reducing R15 value to 33k (instead of 1M) will yield even better results. Here is the complete list of modifications:
